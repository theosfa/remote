...
def main(args: list[str]) -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''Example: 2
            ...
            remote-simple -t 192.168.1.108 -p 5555 -l -e=\"cat/etc/passwd\" # execute command
            echo 'ABC' | ./remote-simple -t 192.168.1.108 -p 135 # echo text to server port 135
            remote-simple -t 192.168.1.108 -p 5555 # connect to server
        '''))
